...
class Commander(wx.Frame):
    ...
    def __init__(self, parent, ser, debug=False):
        wx.Frame.__init__(self, parent, -1, "ArbotiX Commander",
        ...
        wx.StaticLine(self.drive, -1, (width / 2, 0),
        ...
        bodySizer.Add(wx.StaticText(self, -1, "Pan:"), (0, 0),
    ...
    def onTimer(self, event=None):
        ...
        if self.selStrafe.GetValue():
            Buttons = BUT_LT
        self.sendPacket(self.tilt.GetValue(), self.pan.GetValue(),
                        self.forward, self.turn, Buttons)
    ...
    def sendPacket(self, right_vertical, right_horizontal, left_vertical, left_horizontal, Buttons):
        ...
        self.ser.write(chr(255 - ((right_vertical + right_horizontal +
                                   left_vertical + left_horizontal + Buttons) % 256)))
